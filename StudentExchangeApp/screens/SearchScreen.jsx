...
export default function SearchScreen() {
  ...
  const fetchHouses = async () => {
    ...
    setLoading(true);
    const url = `http://192.168.0.11:5000/scrape?country=${country}&city=${city}${university ? `&university=${university}` : ''}`;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tabRow}>
        <TouchableOpacity onPress={() => setTab('connections')} style={[styles.tabBtn, tab === 'connections' && styles.tabActive]}>
          <Text style={styles.tabText}>Connections</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setTab('accommodation')} style={[styles.tabBtn, tab === 'accommodation' && styles.tabActive]}>
